...
namespace BookShop.OracleDAL
{
    ...
    public class SysManage1 : ISysManage//这里必须实现接口，否则工厂类创建接口报错
	{
        ...
        public int AddTreeNode(BookShop.Model.SysNode model)
		{
        ...
        public void UpdateNode(BookShop.Model.SysNode model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// <returns></returns>
        public BookShop.Model.SysNode GetNode(int NodeID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from S_Tree ");	
			strSql.Append(" where NodeID=@NodeID");
            ...
            BookShop.Model.SysNode node = new BookShop.Model.SysNode();
