<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="BookShop.Web.ShoppingCart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Header" runat="server">
    ...
    <script type="text/javascript">
        ...
        function changeBar(operator, cartId, bookId) {
            ...
            $.post("/ashx/EidtCart.ashx", {"action":"edit","count": count, "cartId": cartId }, function (data) {
                if (data == "ok") {
                    //1:将Count的值重新赋值给文本框
        ...
        function removeProductOnShoppingCart(cartId,control) {
            if (confirm("确定要删除该商品吗?")) {
                $.post("/ashx/EidtCart.ashx", { "action": "delete", "cartId": cartId }, function (data) {
                    if (data == "ok") {
